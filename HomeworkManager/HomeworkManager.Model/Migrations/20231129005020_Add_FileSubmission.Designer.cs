...
namespace HomeworkManager.Model.Migrations
{
    ...
    [Migration("20231129005020_Add_FileSubmission")]
    partial class Add_FileSubmission
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HomeworkManager.Model.Entities.Appointment", b =>
                {
            ...
            modelBuilder.Entity("HomeworkManager.Model.Entities.FileSubmission", b =>
                {
            ...
            modelBuilder.Entity("HomeworkManager.Model.Entities.Appointment", b =>
                {
                    ...
                    b.HasOne("HomeworkManager.Model.Entities.User", "Teacher")
            ...
            modelBuilder.Entity("HomeworkManager.Model.Entities.FileSubmission", b =>
                {
                    b.HasOne("HomeworkManager.Model.Entities.Submission", null)
                        .WithOne()
                        .HasForeignKey("HomeworkManager.Model.Entities.FileSubmission", "SubmissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
