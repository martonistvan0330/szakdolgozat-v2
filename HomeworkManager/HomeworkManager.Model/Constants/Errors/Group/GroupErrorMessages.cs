namespace HomeworkManager.Model.Constants.Errors.Group;

public static class GroupErrorMessages
{
    public const string GROUP_NAME_NOT_AVAILABLE = "A group with the specified name already exists!";
