...
public interface IUserRepository
{
    ...
    Task<IEnumerable<UserListRow>> GetAllModelByRoleAsync(string roleName, CancellationToken cancellationToken = default);
    Task<bool> HasRoleByIdAsync(string roleName, Guid userId, CancellationToken cancellationToken = default);
